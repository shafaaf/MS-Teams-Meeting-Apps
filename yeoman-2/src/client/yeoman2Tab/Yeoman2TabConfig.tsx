...
/**
 * Implementation of yeoman 2 Tab configuration page
 */
export const Yeoman2TabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: microsoftTeams.settings.SaveEvent) => {
        ...
        microsoftTeams.settings.setSettings({
            contentUrl: host + "/yeoman2Tab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            websiteUrl: host + "/yeoman2Tab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            suggestedDisplayName: "yeoman 2 Tab",
            removeUrl: host + "/yeoman2Tab/remove.html?theme={theme}",
